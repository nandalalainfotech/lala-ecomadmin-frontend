...
import {
  CountryListDetails,
  deleteCountryMasterlist,
  deleteMultiplecountry,
  updateCountryEnable,
  updatecountryActivate,
} from "../actions/CountryAction";
import {
  COUNTRY_DETAIL_DELETE_RESET,
  COUNTRY_ENABLE_RESET,
  COUNTRY_ENABLE_UPDATES_RESET,
  COUNTRY_MULTIPLE_DELETE_RESET,
...
export const CountryGridScreen = () => {
  ...
  const CountrymultipleDelete = useSelector(
        ...
        <Box sx={{ mt: 2, display: "flex" }}>
          <Breadcrumbs aria-label="breadcrumb flat">
            <div className="breadcrumb flat">
              ...
              <Link to="/countrygrid" className="active">
                Countries
              </Link>
