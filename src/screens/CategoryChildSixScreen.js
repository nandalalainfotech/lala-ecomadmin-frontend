...
function CategoryChildSixScreen() {
  ...
  const editHandler = (id) => {
    navigate(`/testFrom/` + id, { state: { child: "Child5" } });
  };

  const ViewHandeler = (id) => {
    navigate(`/categorychildseven/` + id);
  };
                ...
                for (
                  ...
                  if (
                    categorymasterallList[i].children[j].children[k].children[
                      A
                    ].children[B].children[C]._id === id
                  ) {
                    NewArry.push({
                      ["parentId"]:
                        categorymasterallList[i].children[j].children[k]
                          .children[A].children[B].children[C].parentId,
                      ["childId"]: id,
                      ["childname"]: "child-5",
                      ["child1"]: j,
                      ["child2"]: k,
...
export default CategoryChildSixScreen;
