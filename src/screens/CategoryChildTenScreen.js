...
function CategoryChildTenScreen() {
  ...
  const editHandler = (id) => {
    navigate(`/testFrom/` + id, { state: { child: "Child9" } });
  };
                    ...
                    if (
                      ...
                      for (
                        ...
                        categorymasterallList[i].children[j].children[k]
                          ...
                          .children[E].children[F].children.length;
                        H++
                      ) {
                        ChildrenArray.push(
                          categorymasterallList[i].children[j].children[k]
                            .children[A].children[B].children[C].children[D]
                            .children[E].children[F].children[H]
                        );
                      }
                    }
                  }
                  ...
                  for (
                    ...
                    for (
                      ...
                      if (
                        categorymasterallList[i].children[j].children[k]
                          .children[A].children[B].children[C].children[D]
                          .children[E].children[F]._id === parentId
                      ) {
                        for (
                          let H = 0;
                          H <
                          ...
                          if (
                            categorymasterallList[i].children[j].children[k]
                              .children[A].children[B].children[C].children[D]
                              .children[E].children[F].children[H]?._id === id
                          ) {
                            NewArry.push({
                              ["parentId"]:
                                categorymasterallList[i].children[j].children[k]
                                  ...
                                  D
                                ].children[E].children[F].children[H].parentId,
                              ["childId"]: id,
                              ["childname"]: "child-8",
                              ["child1"]: j,
                              ["child2"]: k,
    ...
    if (window.confirm("Are you sure to delete?")) {
      dispatch(
        deleteCatogry({
          ...
          child8: NewArry[0]?.child8,
          childIndex: NewArry[0]?.childIndex,
        })
      );
    }
  };
...
export default CategoryChildTenScreen;
