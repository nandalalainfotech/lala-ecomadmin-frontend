...
export const UpdatedatagridReducer = (state = {}, action) => {
  switch (action.type) {
    case ORDER_STATUSASSIGN_LIST_REQUEST:
      return { loading: true };
    case ORDER_STATUSASSIGN_LIST_SUCCESS:
      return { loading: false, success: true, order: action.payload };
    case ORDER_STATUSASSIGN_LIST_FAIL:
      return { loading: false, error: action.payload };
    case ORDER_STATUSASSIGN_LIST_RESET:
      return {};
    default:
      return state;
  }
