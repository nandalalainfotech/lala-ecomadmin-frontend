...
export const CominationupdateReducer = (
  state = { loading: true },
  action
) => {
  switch (action.type) {
    case COMBINATION_UPDATE_REQUEST:
      return { loading: true };
    case COMBINATION_UPDATE_SUCCESS:
      return {
        loading: false,
        success: true,
      };
    case COMBINATION_UPDATE_FAIL:
      return { loading: false, error: action.payload };
    case COMBINATION_UPDATE_RESET:
      return {};
    default:
      return state;
  }
